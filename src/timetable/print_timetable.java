...
public final class print_timetable extends javax.swing.JFrame implements Printable {
...
MessageFormat headerFormat = new MessageFormat("Time Management Tool - Page {0}");
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(print_timetable.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
