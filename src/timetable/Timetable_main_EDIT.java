...
public class Timetable_main_EDIT {
 ...
 {
     String s = Timetable_main_EDIT.subject;
         s.trim();
             Timetable_main_EDIT.subject = s;
        
     String d1 = Timetable_main_EDIT.desc;
         d1.trim();
             Timetable_main_EDIT.desc = d1;  
        
     String d2 = Timetable_main_EDIT.diff;
         d2.trim();
             Timetable_main_EDIT.diff = d2;   
 }
...
raflength =   (((int) raf.length())/538);
  ...
  Timetable_main_EDIT.ID = raf.readInt();
  Timetable_main_EDIT.subject = raf.readUTF();
  Timetable_main_EDIT.desc = raf.readUTF();
  Timetable_main_EDIT.diff = raf.readUTF();
  Timetable_main_EDIT.time = raf.read();
  Timetable_main_EDIT.delete = raf.read();
